...
TARGETNAME := EmbeddedProject3.elf
...
SOURCEFILES := $(BSP_ROOT)/KL27Z644/StartupFiles/startup.c $(BSP_ROOT)/KL27Z644/StartupFiles/vectors_KL27Z644.c $(BSP_ROOT)/platform/devices/MKL27Z644/startup/system_MKL27Z644.c LEDBlink.cpp
EXTERNAL_LIBS := 
...
$(BINARYDIR)/startup.o : $(BSP_ROOT)/KL27Z644/StartupFiles/startup.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/vectors_KL27Z644.o : $(BSP_ROOT)/KL27Z644/StartupFiles/vectors_KL27Z644.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/system_MKL27Z644.o : $(BSP_ROOT)/platform/devices/MKL27Z644/startup/system_MKL27Z644.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
